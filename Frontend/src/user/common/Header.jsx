...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-blue-800 left-0 top-0 z-20 flex items-center">
              ...
              <div>
                ...
                >
                  <ul className="block lg:flex text-white">
                    ...
                    <ListItem NavLink="/search_car">Search car</ListItem>
                    <ListItem NavLink="/request">My Request</ListItem>
