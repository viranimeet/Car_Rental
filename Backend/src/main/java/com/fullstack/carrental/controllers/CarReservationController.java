...
//    public ResponseEntity<List<CarReservationDto>> getUserReservations(@PathVariable Long userId) {
//        List<CarReservationDto> userReservations = carReservationService.getUserReservations(userId);
